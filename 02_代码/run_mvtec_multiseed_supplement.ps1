# 027 MVTec 补齐实验脚本（种子 41, 53）
# 等待 050 VisA 实验完成后运行

$PYTHON = "python"
$SCRIPT = "C:\Users\PC\Documents\Codex\实验\06_主线项目/027_自适应稀疏注意力与准确率效率前沿\02_代码\evaluate_mvtec_selective.py"
$DATA = "D:\data数据集\MVTec AD"
$OUT = "C:\Users\PC\Documents\Codex\实验\06_主线项目\027_自适应稀疏注意力与准确率效率前沿\05_运行记录\一区候选_027_mvtec_multiseed"
