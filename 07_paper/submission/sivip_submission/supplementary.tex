...
The reproducibility materials record the random seeds, category lists, budget values, derived tables, and figure source data. Code, environment specifications, and regeneration scripts will be archived in the project repository at \url{https://github.com/cdhuangjin/fixed-budget-patch-routing}.
