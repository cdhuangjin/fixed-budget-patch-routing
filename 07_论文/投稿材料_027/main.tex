...
This study uses public image datasets and does not involve human participants, animals or personally identifiable information. The main submission package includes the split protocol, source data for the figures, unit-level result files and evaluation scripts. Public dataset sources are cited in the reference list. The source code and supplementary materials are available at \url{https://github.com/cdhuangjin/fixed-budget-patch-routing}.
