...
Scope: full `references.bib`, 19 entries; Crossref DOI checks plus official CVF/Springer/Journal pages where available.

## Result summary

- Verified or corrected: 19/19 entries are now usable in the manuscript.
